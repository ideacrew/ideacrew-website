...
- Take full ownership of quality outcomes, driving test strategy, execution, and defect resolution with a high level of accountability.
- Proactively communicate testing progress, risks, and blockers, ensuring clear, timely alignment with Delivery, Product, and Engineering stakeholders.
...
- A strong emphasis is placed on automation, with expectations to design, implement, and maintain automated test coverage that supports scalable, efficient, and reliable software delivery.
- Experience or familiarity with accessibility testing standards (WCAG) and tools.
